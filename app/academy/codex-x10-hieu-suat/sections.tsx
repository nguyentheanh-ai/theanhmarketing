...
import { startCheckoutCountdown } from "@/components/payment/checkout-countdown";
import { CheckoutTransition } from "@/components/payment/checkout-transition";
...
export function CodexOffer() {
  ...
  const transitionRef = useRef<ReturnType<typeof startCheckoutCountdown> | null>(null);
  ...
  const payNow = couponApplied ? Math.round(CODEX_AGENT_KIT_OFFER.price * 0.8) : CODEX_AGENT_KIT_OFFER.price;
