  ...
  return (
    <main className="min-h-screen bg-[#f7f8fb] text-slate-950">
      ...
      <section className="mx-auto max-w-6xl px-5 pb-20 pt-12 sm:pt-16">
        ...
        <div className="mx-auto mt-8 max-w-5xl"><SupportBookingForm bookableDays={availability.days} today={today} /></div>
      </section>
    </main>
  );
}
