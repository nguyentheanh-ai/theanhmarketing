...
CANDIDATE correction: per-function regions trong vercel.json theo tài liệu Vercel hiện tại; kiểm tra header live sau deploy. Không đổi toàn bộ default region hoặc chuyển Edge để né vấn đề. Không áp dụng kết luận này cho Edge runtime hay builder khác chưa kiểm tra.
