...
Migration `20260905055235_support_booking_public_duration.sql` adds duration/type, computed price constraints and a held/confirmed interval exclusion constraint. Private reserve v2 and compatible old RPC use a day lock shared with confirmation. Historical amounts remain valid. See `docs/SUPPORT_BOOKING_PUBLIC_DURATION_20260905.md` for local verification and release prerequisites.
