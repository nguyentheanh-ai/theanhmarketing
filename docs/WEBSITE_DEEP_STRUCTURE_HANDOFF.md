...
- Production verification: commit `2de749c`, deployment `5piM1VBQ3FfVz53h8vpLFeN24ZU2`, aliased to `https://www.theanhmarketing.com`. Live HTML at `/academy/facebook-ads-master-2026` is byte-identical to the published source and contains all 12 progress-dot buttons.
...
## 22/09/2026 — Landing mẫu chuyên gia (LOCAL_REVIEW)

Một mẫu tại `/academy/quang-cao-chuyen-gia`, nội dung học Facebook Ads hiện tại, gói mới `industry-expert-1290` = 1.290.000đ, cùng quyền `facebook-ads-2026`. Chưa deploy/data mutation. 72 tests, TypeScript, lint, webpack build PASS; HTTP route/assets local verified; chưa browser/transaction thật. Chi tiết `docs/INDUSTRY_LANDING_20260922.md`.
