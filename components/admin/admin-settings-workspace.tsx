...
export function AdminSettingsWorkspace({ role }: { role: AdminRole }) {
 ...
 return <div className="space-y-5"><header><h1 className="text-2xl font-bold tracking-tight">Cài đặt</h1><p className="mt-1 text-sm text-slate-500">Chọn nhóm công việc để mở đúng công cụ.</p></header>
