          ...
          {displayDates.map((date, index) => {
            ...
            return (
              ...
              >
                ...
                <span className="block text-[10px] font-bold">{sunday ? "Nghỉ" : index < SUPPORT_MIN_LEAD_DAYS ? "Chưa mở" : locked ? "Hết lịch" : "Còn lịch"}</span>
              </button>
            );
          })}
        </div>
        <p className="mt-4 text-sm font-semibold leading-6 text-slate-500">Vui lòng đặt lịch trước ít nhất {SUPPORT_MIN_LEAD_DAYS} ngày. Không nhận lịch hỗ trợ vào Chủ nhật.</p>
      </section>
