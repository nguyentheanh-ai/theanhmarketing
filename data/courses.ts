...
const courseFunnel: FunnelCourseConfig[] = [
  ...
  },
  {
    ...
    landingPageUrl: "/academy/ebook-facebook-ads-2026-premium",
    status: "open",
    statusLabel: "Đang mở đăng ký",
    ...
    description:
      "Thư viện kiến thức Facebook Ads 2026 được tổ chức như một ebook/website thực hành, giúp người dùng mở đúng phần cần làm: mục tiêu quảng cáo, target, content, Pixel, CAPI, remarketing, testing, scale, chính sách và báo cáo.",
  ...
  },
  {
    ...
    landingPageUrl: "/academy/bo-kit-agent-doanh-nghiep",
    status: "open",
    statusLabel: "Đang mở đăng ký",
    ...
    description:
      "Đội ngũ nhân sự AI giúp doanh nghiệp phân vai 8 Nhân viên AI cho điều hành, nghiên cứu, marketing, content, design, editor, quảng cáo và web/landing.",
    topics: ["Agent Kit", "SOP", "Automation"],
    outcomes: [
      "Có 8 Nhân viên AI theo từng phần việc của phòng ban marketing.",
      "Tự đào tạo nhân viên cho riêng doanh nghiệp mình từ dữ liệu đã duyệt.",
      "Vận hành quảng cáo theo SOP chuyên nghiệp và có điểm kiểm tra rõ.",
    ],
  },
  {
    tier: "Nâng cao",
  ...
  },
  {
    ...
    landingPageUrl: "/academy/ai-master-x10-hieu-suat",
    status: "open",
    statusLabel: "Đang mở đăng ký",
...
function makeLessons(slug: string, title: string): CourseLesson[] {
  if (slug === "facebook-ads-2026") {
    return [
      ...
      {
        id: "lesson-message-ads",
        title: "Bài 17 - Hướng dẫn lên quảng cáo tin nhắn",
        duration: "Video bài học",
        order: 3,
        youtubeUrl: "https://www.youtube.com/watch?v=auPdBJGY_pQ",
        embedUrl: "https://www.youtube.com/embed/auPdBJGY_pQ",
        access: "paid",
        allowComments: true,
      },
    ];
      ...
      lessons: [
        {
          ...
          embedUrl: "",
          access: "paid",
          resources: [{ title: "AI Growth Toolkit", url: "/tai-lieu" }],
          allowComments: true,
        },
        {
          id: "lesson-9",
